  ...
  const fetchSettings = async () => {
    ...
    try {
      ...
      if (data.settings) {
        ...
        const sanitizedSettings = Object.keys(data.settings).reduce((acc: any, key) => {
          acc[key] = data.settings[key] === null ? '' : data.settings[key]
          return acc
        }, {})
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-6">
          ...
          {/* Notice Banner */}
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Notice Banner</h2>
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Notice Text</label>
                <textarea
              ...
              <div className="flex items-center">
                ...
                />
                <label className="ml-2 block text-sm text-gray-900 dark:text-white">Show Notice Banner</label>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 md:col-span-2">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Bank Account Details</h2>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">These details will be shown to users during checkout for bank transfer payments.</p>
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                  placeholder="e.g., iDealioLanka Pvt Ltd"
                />
              </div>
              <div>
          ...
          {/* Legal Pages */}
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 md:col-span-2">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Legal Pages</h2>
            <div className="grid md:grid-cols-2 gap-4">
              <div>
